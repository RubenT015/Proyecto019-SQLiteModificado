package com.example.rt.proyecto019_sqlitemodificado;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void consultaPorCodigo(View v){
        ...
        if(fila.moveToFirst()){
            ...
            do{
                ...
                tv.setText(miCodigo+" : "+fila.getString(0)+" : "+fila.getString(1));
                layout.addView(tv);
    ...
    public void consultaPorDescripcion(View v){
        ...
        if(fila.moveToFirst()){
            ...
            do{
                TextView tv = new TextView(this);
                tv.setText(fila.getString(0)+" : "+miDescripcion+" : "+fila.getString(1));
                layout.addView(tv);
            }while(fila.moveToNext());
        }
        else
    ...
    public void listarTodos(View v){
        ...
        if(fila.moveToFirst()){
            do{
                TextView tv = new TextView(this);
                tv.setText(fila.getString(0)+" : "+fila.getString(1)+" : "+fila.getString(2));
                layout.addView(tv);
            }while(fila.moveToNext());
        }
        bd.close();
